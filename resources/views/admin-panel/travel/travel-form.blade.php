...
@section('title')
{{ __('Travels') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Travels') }}
                                ...
                                @if($travel->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $travel->id ] ) }}"
                                    ...
                                    <form
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $travel->first_name }}{{ request()->segment(count(request()->segments())) == 'create' ? old('first_name') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $travel->last_name }}{{ request()->segment(count(request()->segments())) == 'create' ? old('last_name') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $travel->car_number }}{{ request()->segment(count(request()->segments())) == 'create' ? old('car_number') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $travel->car_model }}{{ request()->segment(count(request()->segments())) == 'create' ? old('car_model') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <script>
                                                            document.getElementById("dateFieldBirthday").value = new Date("{{ $travel->birthday }}").toISOString().substring(0, 10)
                                                        </script>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <script>
                                                            document.getElementById("dateFieldStartWorking").value = new Date("{{ $travel->start_working }}").toISOString().substring(0, 10)
                                                        </script>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $travel->username }}{{ request()->segment(count(request()->segments())) == 'create' ? old('username') : '' }}" />
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                value="{{ $travel->status }}{{ request()->segment(count(request()->segments())) == 'create' ? old('status') : '' }}" >
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $travel->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $travel->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($travel->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $travel->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $travel->id ? 'text-dark' : '' }}">
                                                    {{ $travel->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
