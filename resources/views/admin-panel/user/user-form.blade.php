                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $user->car_number }}{{ request()->segment(count(request()->segments())) == 'create' ? old('car_number') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $user->car_model }}{{ request()->segment(count(request()->segments())) == 'create' ? old('car_model') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <script>
                                                            document.getElementById("dateFieldBirthday").value = new Date("{{ $user->birthday }}").toISOString().substring(0, 10)
                                                        </script>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <script>
                                                            document.getElementById("dateFieldStartWorking").value = new Date("{{ $user->start_working }}").toISOString().substring(0, 10)
                                                        </script>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $user->username }}{{ request()->segment(count(request()->segments())) == 'create' ? old('username') : '' }}" />
