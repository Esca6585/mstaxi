                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">{{ __('Tarifs') }}</a>
                                        </li>
                                    ...
                                    <div class="row mb-17">
                                        <div class="col-xxl-5 mb-11 mb-xxl-0">
                                            ...
                                            <div class="card card-custom card-stretch">
                                                <div class="card-body p-0 rounded px-10 py-15 d-flex align-items-center justify-content-center"
                                                    ...
                                                    @if($tarif->image)
                                                    <img src="{{ asset($tarif->image) }}" class="mw-100 w-200px"
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">
                                                {{ $tarif->{ 'name_' . app()->getlocale() } }}
                                            </h2>

                                            <h5><b>{{ __('minimum price') }}: </b>{{ $tarif->minimum_price }}</h5>
                                            ...
                                            <h5><b>{{ __('every waiting price free') }}: </b>{{ $tarif->every_waiting_price_free }}</h5>
