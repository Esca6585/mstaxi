...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            ...
            <!--end::User-->
            <!--begin::Travel-->
            <li class="menu-item {{ Request::is('*/admin/travel*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('travel.index', app()->getlocale() ) }}" class="menu-link">
                    <span class="svg-icon menu-icon">
                        <img src="{{ asset('metronic-template/v7/assets/media/icons/duotone/Navigation/Route.svg') }}" alt="{{ asset('metronic-template/v7/assets/media/icons/duotone/Navigation/Route.svg') }}" width="20px" >
                    </span>
