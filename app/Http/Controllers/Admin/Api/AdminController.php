...
class AdminController extends Controller
{
    ...
    public function userStatistic()
    {
        $users = \DB::table('users')
                    ...
                    ->select('users.id', 'users.first_name', 'users.last_name', 'users.status', 'users.online', 'users.time', \DB::raw('sum(travels.km) as all_km'), DB::raw('sum(travels.price) as all_price'))
                    ->groupBy('users.id', 'users.first_name', 'users.last_name', 'users.status', 'users.online', 'users.time')
                    ->get();
